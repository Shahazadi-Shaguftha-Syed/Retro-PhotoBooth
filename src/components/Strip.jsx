  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      {Array.from({ length: stripCount }).map((_, i) => (
        frames[i] ? (
          <div key={i} className="photo-developing" style={{ position: 'relative', aspectRatio: '4/3', borderRadius: 1, overflow: 'hidden', background: '#0a0908', border: '1px solid var(--border)' }}>
            <canvas
